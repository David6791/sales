                                ...
                                @foreach($data as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span>
                                                <img src="{{ asset('storage/productos/' . $product->imagen) }}" alt="" heigth="70" width="80" class="rounded">
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <a href="javascript:void(0)" wire:click="Edit({{$product->id}})" class="btn btn-info btn-sm" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0)" onclick="Confirm('{{$product->id}}')" class="btn btn-danger btn-sm" title="Borrar">
